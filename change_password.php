...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!$stmt->execute([$hashed_password, $user_id])) {
            ...
            throw new Exception("Failed to update password: " . $error_info[2]);
        }
    ...
    <div class="profile-container">
        <div class="profile-sidebar">
            ...
            <ul>
                ...
                <li><a href="change_password.php" class="active"><img src="assets/icon/padlock.png" alt="Password">Change Password</a></li>
