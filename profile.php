...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Validate phone number (basic regex for digits, optional + and spaces/hyphens)
        ...
        if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] === UPLOAD_ERR_OK) {
            ...
            $file_name = $user_id . '_' . time() . '.' . pathinfo($_FILES['profile_picture']['name'], PATHINFO_EXTENSION);
            ...
            if (!move_uploaded_file($_FILES['profile_picture']['tmp_name'], $file_path)) {
                ...
                throw new Exception("Failed to upload profile picture: $error_message");
            }

            // Delete old profile picture if it exists and is not the default
            if ($profile_picture && $profile_picture !== 'assets/default_avatar.png' && file_exists($profile_picture)) {
                if (!unlink($profile_picture)) {
                    error_log("Failed to delete old profile picture: $profile_picture");
                }
            }
        ...
        $set_clause = "full_name = ?, email = ?, phone_number = ?, address = ?, profile_picture = ?";
        $params = [$full_name, $email, $phone_number, $address, $profile_picture, $user_id];

        $stmt = $pdo->prepare("UPDATE users SET $set_clause WHERE user_id = ?");
        if (!$stmt->execute($params)) {
            $error_info = $stmt->errorInfo();
            error_log("SQL Error: " . json_encode($error_info));
            throw new Exception("Failed to update profile: " . $error_info[2]);
        }
...
<body>
    ...
    <div class="profile-container">
        <div class="profile-sidebar">
            ...
            <ul>
                <li><a href="profile.php" class="active"><img src="assets/icon/user.png" alt="Profile">Profile Details</a></li>
                ...
                <li><a href="delete_account.php"><img src="assets/icon/delete.png" alt="Delete">Delete Account</a></li>
            ...
            <form class="profile-form" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="avatar-upload">
                        <img src="<?php echo htmlspecialchars($user['profile_picture'] ?: 'assets/default_avatar.png'); ?>" alt="Current Avatar">
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" name="address" placeholder="Enter your address"><?php echo htmlspecialchars($user['address'] ?? ''); ?></textarea>
                </div>
